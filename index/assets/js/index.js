let working = [
  ...
  let workingpg = working.filter(x=> x.id == 11075)
  console.log(workingpg);



  let workingfp = working.filter(x=> x.shipAddress.country === 'USA')
  console.log(workingfp);





  let code = "MənCodeAcademydəProgramingtədrisialıram"
